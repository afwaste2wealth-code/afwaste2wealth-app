...
/* =========================================================
   A&F GLOBAL DATE & TIME DISPLAY CONTROLLER

   Applies Director's saved display preferences
   throughout dynamically generated screens.

   IMPORTANT:
   - Display only
   - Stored dates remain YYYY-MM-DD
   - Date inputs are NOT changed
   - Calculations are NOT changed
   ========================================================= */

(function connectAFGlobalDateTimeDisplayController() {

  let afDateTimeFormatting = false;


  /* =======================================================
     CHECK WHETHER TEXT SHOULD BE LEFT ALONE
     ======================================================= */

  function afDateTimeProtected(node) {
...
node.parentElement;
    ...
    /*
     * Never modify controls or code.
     */
    if (
parent.closest(
        "input, select, option, textarea, script, style"
      )
    ) {
  ...
  function afFormatVisibleTimestamp(value) {

    if (
typeof window.formatAFDateTime ===
      "function"
    ) {
  ...
  /* =======================================================
     FORMAT ONE YYYY-MM-DD DATE
     ======================================================= */

  function afFormatVisibleDate(value) {
...
typeof window.formatAFDate ===
  ...
  function afProcessDateTimeTextNode(node) {
